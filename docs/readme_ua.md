...
# Улюблене
- <a href="https://github.com/mishakorzik/MyMods-ForMinecraft">Мої Моди-Майнкрафт</a>
...
---
 ...
 ### Вплив
 _Цей сайт безпечний для дітей від 7 років, тому проблем не буде_

 ### Патчі
 _Чи виправлено проблему?  До яких версій користувачі повинні перейти? _ТАК!

 ### Обхідні шляхи
 _Чи є спосіб для користувачів виправити або усунути вразливість без оновлення? _ТАК!

 ### Посилання
 _Чи є посилання, які користувачі можуть відвідати, щоб дізнатись більше? _ТАК!

 ### Для отримання додаткової інформації
 Якщо у вас є які-небудь запитання чи коментарі щодо цього повідомлення:
 * Відкрийте проблему в 
 *[приклад посилання на репо] (http://example.com)
 * Надішліть нам електронного листа на 
 *[приклад електронної адреси] (mailto: example@gmail.com)
...
І можеш не переживати етод сайт конфіденційність захищених
 І сертифікат безпеки ще робочий і з'єднання є захищене
###### by mishakorzik
...
Якщо ти ще не віриш то ти можеш подивитися нашу ліцензію
Або подивитися поліцію безпеки там можна подивитися які
У нас версії самі новіші і свіжі.
