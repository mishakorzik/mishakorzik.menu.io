...
13.<a href="https://github.com/mishakorzik/Free-Proxy">Бесплатны прокси</a>

14. <a href="https://github.com/mishakorzik/Mask-Phish.Termux">Маскировка фишинга</a>

15. <a href="https://github.com/mishakorzik/AllHackingTools">Всё Инструмент для хакинга</a>
...
---
 ...
 ### Влияние
 _Данный сайт безопасен для детей от 7 лет, поэтому проблем не возникнет_

 ### Патчи
 _Проблема устранена?  До каких версий следует перейти на новую версию? _ДА!

 ### Обходные пути
 _Есть ли способ исправить или устранить уязвимость без обновления? _ДА!

 ### Ссылки
 _Есть ли ссылки, по которым пользователи могут узнать больше? _ДА!

 ### Чтобы получить больше информации
 Если у вас есть какие-либо вопросы или комментарии по поводу этого совета:
 * Откройте проблему в [пример ссылки на репо] (http://example.com)
 * Напишите нам по адресу [пример адреса электронной почты] (mailto: misakorzik528@gmail.com)
